...
import Progress from "../../buyelectricity/components/Progress";
...
const Completed = ({ progress }: Props) => {
  return (
    <section className="md:mb-[100px] mb-[25px] px-4 pt-4">
      <Progress progress={progress} />
      <div className="flex flex-col justify-evenly items-center mt-[50px] ">
        <div className="w-[343px] sm:w-[390px]">
          <div className="">
        ...
        <div className="bg-[#F6F9FF] border border-[#B5CDF8] rounded-md flex flex-col justify-evenly w-[343px] sm:w-[390px] h-[85px] text-center mb-[12px]">
        ...
        <div className="border border-[#83ADF5] rounded-md flex flex-col justify-evenly items-center w-[343px] sm:w-[390px] h-[85px] text-center mb-[12px]">
        ...
        <div className="space-y-3 flex flex-col items-center mx-auto">
          ...
          <CustomButton
            ...
            btnType="submit"
            containerStyles="border border-primary h-[48px] font-bold  text-primary rounded-md w-[343px] sm:w-[390px] "
            //   disabled={isLoading}
          /></Link>
          ...
          <CustomButton
            ...
            btnType="submit"
            containerStyles="border border-primary  h-[48px] bg-primary font-bold   text-white rounded-md w-[343px] sm:w-[390px]"
            //   disabled={isLoading}
          />
          </Link>
          ...
          <CustomButton
            title={"Need help?"}
            btnType="submit"
            containerStyles="h-[48px] text-[#56585C] rounded-md w-[343px] sm:w-[390px]"
            //   disabled={isLoading}
          />
        </div>

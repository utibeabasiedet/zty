...
const Process = ({ progress, handleNextStep }: Props) => {
  return (
    <section className="md:mb-[100px] mb-[25px] px-4 pt-4">
      ...
      <div className="flex flex-col sm:w-[390px] mx-auto justify-evenly items-center mt-[50px] ">
    ...
    >
      ...
      />
        ...
        <div className="bg-[#F6F9FF] max-w-[314px] sm:w-[390px] h-[56px] text-center mb-[12px]">
        ...
        <div className="space-y-3 flex flex-col items-center mx-auto">
          ...
          <CustomButton
            title={"Need help?"}
            btnType="submit"
            containerStyles="h-[48px] text-[#56585C] rounded-md w-[314px] sm:w-[390px]"
